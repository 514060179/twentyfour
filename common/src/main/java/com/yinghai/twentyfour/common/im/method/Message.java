...
import com.yinghai.twentyfour.common.im.model.HistoryMessageResult;
import com.yinghai.twentyfour.common.im.model.TemplateMessage;
...
//		TemplateMessage templateMessage = new TemplateMessage("test01",new String[]{"test02"},"测试内容",);
		try {
//			System.out.println(m.publishPrivate("test01",new String[]{"test02"},new TxtMessage("你好！，测试内容",new Date().toString()),"test","test","1",1,1,1,1));
			System.out.println(m.getHistory("2017110616"));
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
